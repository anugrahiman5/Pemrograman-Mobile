...
public class WeatherAdapter extends RecyclerView.Adapter<WeatherAdapter.WeatherViewHolder> {
    private ArrayList<WeathersItems> mData = new ArrayList<>();
    ...
    public class WeatherViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(WeathersItems weathersItems) {
            textViewNamaKota.setText(weathersItems.getName());
            textViewTemperature.setText(weathersItems.getTemp());
            textViewDescription.setText(weathersItems.getDesc());
        }
    }
}
